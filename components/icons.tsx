...
export const GeminiLogo: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12.922,10.352a3.848,3.848,0,0,1,1.178,5.326,3.848,3.848,0,0,1-5.326-1.178,3.848,3.848,0,0,1,4.148-4.148Zm-2.3,4.02a2.3,2.3,0,1,0,0-3.248,2.3,2.3,0,0,0,0,3.248Z" />
      <path d="M12,2A10,10,0,1,0,22,12,10,10,0,0,0,12,2Zm5.05,13.6,-2.9-2.9a5.4,5.4,0,0,0-5.75-1.5,5.4,5.4,0,0,0,1.5,5.75l2.9,2.9a5.4,5.4,0,0,0,7.65,0,5.4,5.4,0,0,0-3.4-7.25Z" />
    </svg>
);
